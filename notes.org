...
- PSU tests and schematic DONE - footprints to watch: switch, all transistors, fuse holder, pots, jacks...

- footprints for switch, fuse-geiger holder(from gieger.brd we now have), add outline for sample holder/resin block
